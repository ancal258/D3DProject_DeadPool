...
private:
	enum MESH_SELECT {
		...
		MESH_ACCESSROOF, MESH_ACCESSROOF03,ACVENT_01, MESH_ACVENT_02, MESH_BACKGROUNDBUILDING, MESH_BACKGROUNDBUILDING_DESTROY, MESH_CABINET, MESH_FUELTANK, MESH_GENERICBOX, MESH_GWN_SIGN, MESH_GWN_WALL01, MESH_GWN_WALL02, MESH_GWN_WALL03,
		MESH_INDUSTRIALBOX, MESH_INDUSTRIALCART, MESH_INDUSTRIALGENERATOR, MESH_LADDER, MESH_LIGHT_BASE_01, MESH_LIGHT_BASE_02, MESH_MAINBUILDING_01, MESH_MAINBUILDING_02, MESH_OUTDOORPIPE, MESH_RADIOTOWER01, MESH_ROOFTOPAC, MESH_STRUCTURE01,
		MESH_TOOLBOX, MESH_TRANSFORMER01, MESH_TRANSFORMER02, MESH_TRASHBAGSPILLED, MESH_TRISENTINEL, MESH_WATERHEATER01,// MAP
