...
private:
	enum MESH_SELECT {
		...
		MESH_FUELTANK, MESH_GENERICBOX,	MESH_GWN_SIGN, MESH_GWN_WALL01, MESH_GWN_WALL02, MESH_GWN_WALL03, MESH_HALLYWAYCOVER ,MESH_INDUSTRIALBOX, MESH_INDUSTRIALCART, MESH_INDUSTRIALGENERATOR, MESH_LADDER, MESH_LIGHT_BASE_01, 
