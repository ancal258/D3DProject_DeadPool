...
class CEventCube final : public CGameObject
{

private:
	explicit CEventCube(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CEventCube(const CEventCube& rhs);
	virtual ~CEventCube() = default;
public:
...
public:
	static CEventCube* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
