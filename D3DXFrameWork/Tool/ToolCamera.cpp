...
CToolCamera::CToolCamera(LPDIRECT3DDEVICE9 pGraphic_Device)
...
HRESULT CToolCamera::Ready_GameObject_Prototype()
{
...
void CToolCamera::Render_GameObject()
{
}

HRESULT CToolCamera::SetUp_CameraInfo(CAMERADESC CamDesc, PROJDESC ProjDesc)
{
...
CToolCamera * CToolCamera::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CToolCamera*		pInstance = new CToolCamera(pGraphic_Device);

	if (FAILED(pInstance->Ready_GameObject_Prototype()))
	{
		_MSG_BOX("CToolCamera Created Failed");
...
CGameObject * CToolCamera::Clone_GameObject()
{
	CToolCamera*		pInstance = new CToolCamera(*this);

	if (FAILED(pInstance->Ready_GameObject()))
	{
		_MSG_BOX("CToolCamera Clone Failed");
		Safe_Release(pInstance);
	}
