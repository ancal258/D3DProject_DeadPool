...
HRESULT CTexture::Ready_Texture(TEXTURETYPE eType, const _tchar * pFileName, const _uint & iCnt)
{
	...
	for (size_t i = 0; i < iCnt; ++i)
	{
		...
		{
		case TYPE_GENERAL:
			hr = D3DXCreateTextureFromFile(Get_Graphic_Device(), szFullPath, (LPDIRECT3DTEXTURE9*)&pTexture);
			break;
		case TYPE_CUBE:
			hr = D3DXCreateCubeTextureFromFile(Get_Graphic_Device(), szFullPath, (LPDIRECT3DCUBETEXTURE9*)&pTexture);
			break;
		}
