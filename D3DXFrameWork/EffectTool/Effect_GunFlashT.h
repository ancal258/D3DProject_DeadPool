...
class CEffect_GunFlashT final : public CGameObject
{
private:
	explicit CEffect_GunFlashT(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CEffect_GunFlashT(const CEffect_GunFlashT& rhs);
	virtual ~CEffect_GunFlashT() = default;
public:
...
public:
	static CEffect_GunFlashT* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
