...
void CParentEffect::Set_EffectInfo(_float fFrameSpeed, _float fFrameMax, _float fMoveSpeed, _float fSurviveTime, _float fDegreeRange, _vec3 * vSetScale, _vec3 * vSetPos, _vec3 * vDir, _bool isSettingPos, _bool isRandomPos, _float fCreateTime)
{
