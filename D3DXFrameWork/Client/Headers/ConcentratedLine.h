...
_BEGIN(Client)
class CPlayer;
class CConcentratedLine final : public CGameObject
{
private:
	explicit CConcentratedLine(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CConcentratedLine(const CConcentratedLine& rhs);
	virtual ~CConcentratedLine() = default;
public:
...
public:
	static CConcentratedLine* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
