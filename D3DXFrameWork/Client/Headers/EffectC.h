...
class CEffectC abstract : public CGameObject
{
protected:
	explicit CEffectC(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CEffectC(const CEffectC& rhs);
	virtual ~CEffectC() = default;
public:
