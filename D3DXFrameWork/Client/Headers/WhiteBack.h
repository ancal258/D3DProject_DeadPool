...
_BEGIN(Client)
class CPlayer;
class CWhiteBack final : public CGameObject
{
private:
	explicit CWhiteBack(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CWhiteBack(const CWhiteBack& rhs);
	virtual ~CWhiteBack() = default;
public:
...
public:
	static CWhiteBack* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
