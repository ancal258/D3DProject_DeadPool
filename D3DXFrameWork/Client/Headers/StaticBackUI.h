...
_BEGIN(Client)
class CPlayer;
class CStaticBackUI final : public CGameObject
{
private:
	explicit CStaticBackUI(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CStaticBackUI(const CStaticBackUI& rhs);
	virtual ~CStaticBackUI() = default;
public:
...
public:
	static CStaticBackUI* Create(LPDIRECT3DDEVICE9 pGraphic_Device, _uint iKind);
