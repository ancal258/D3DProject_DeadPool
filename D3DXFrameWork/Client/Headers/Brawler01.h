...
{
private:
	enum Brawler01 {STATE_IDLE , STATE_BREAK_ANIMATION, STATE_ATTACK_DEFAULT, STATE_ATTACK_CROSS, STATE_DEATH_F, STATE_DEATH_L, STATE_DEATH_LL, STATE_DEATH_R,STATE_DEATH_RL , STATE_WALK_F , STATE_END};
private:
